...
<head>
	...
	<title>Admin : compétences
		<?php echo($ligne_utilisateur['pseudo']); ?>
	</title>
...
<body>
	...
	<div class="container">
		<!--container pour un container fixed width-->
					...
					<div class="panel-body">
						<table class="table table-hover">
							...
							<tbody>
								<tr>
									<td>
										<?php echo $ligne_titre_cv['titre_cv']; ?>
									</td>
									<td>
										<?php echo $ligne_titre_cv['accroche']; ?>
									</td>
									<td><img src="img/<?php echo $ligne_titre_cv['logo']; ?>" width="100" height="100">
									</td>>
								</tr>
							</tbody>
						</table>
					...
					<div class="panel-body">
						...
						<form action="titre_cv.php" method="post">
							...
							<div class="form-group">
								...
								<textarea name="accroche" id="accroche" class="form-control" placeholder="Insérer l'accroche">
									<?php echo $ligne_titre_cv['accroche']; ?>
								</textarea>
							</div>
							<div class="form-group">
		...
		<div class="row">
			<div class="text-center col-md-12">
				<div class="well"><strong>Composants Bootstrap de base</strong>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="text-center col-sm-4">
				...
				<div class="row">
					<div class="col-xs-4"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span>
					</div>
					<div class="col-xs-4"><span class="glyphicon glyphicon-home" aria-hidden="true"> </span> </div>
					<div class="col-xs-4"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span>
					</div>
				</div>
			</div>
		</div>
