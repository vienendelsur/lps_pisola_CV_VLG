<!--navigation en include-->
  ...
  <div class="container-fluid"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="../admin/index.php"><?php echo($ligne_utilisateur['pseudo']); ?></a>
	</div>
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse fond_nav" id="defaultNavbar1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="../admin/profil.php">Mon profil<span class="sr-only">(current)</span></a></li>
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Parcours<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="../admin/experiences.php">Expériences</a></li>
            <li><a href="../admin/formations.php">Formations</a></li>
            <li><a href="../admin/realisations.php">Réalisations</a></li>
            <li class="divider"></li>
            <li><a href="../admin/titre_cv.php">Titre du CV</a></li>
            <li class="divider"></li>
         ...
         <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Compétences et divers<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="../admin/competences.php">Compétences</a></li>
            <li><a href="../admin/loisirs.php">Loisirs</a></li>
            <li><a href="../admin/reseaux.php">Réseaux sociaux</a></li>
            <li class="divider"></li>
